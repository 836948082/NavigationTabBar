    ...
    private void initUI() {
        ...
        viewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(final ViewGroup container, final int position) {
                final View view = LayoutInflater.from(TopHorizontalNtbActivity.this).inflate(R.layout.item_vp_list, null, false);

                final RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.rv);
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(new LinearLayoutManager(TopHorizontalNtbActivity.this, LinearLayoutManager.VERTICAL, false));
